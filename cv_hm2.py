...
def main():
    ...
    parser.add_argument("-est", "--estimator", dest="threshold",
                        help="Specify the threshold value, LS and RO - any value, [0,1] - GA", required=True,
                        type=float)
    ...
    if args.model == 'RO':
        ...
        line_fitting_robust, thresholded_robust, segmented_robust = fitting_object.fit_line_robust(data_points, args.threshold, args.estimator)
